      ...
      <div class="bg-dark-dark max-w-6xl px-10 py-10 mx-auto mt-8 text-left rounded">
        ...
        <div v-else-if="fetchError && errorCode == 401" class="text-gray-100 text-center">
          ...
          <div class="text-lg mt-2 max-w-4xl mx-auto">
            To get a count of your servers, you need to log in with Discord. InterstallerTools never stores or logs any of your data. This website is open source on
            ...
            <div v-if="showList" class="bg-dark-darker rounded-xl max-w-xl p-5 mx-auto mt-5 text-center">
              <div v-for="guild in guilds.all" :key="guild.id" class="flex items-center justify-center overflow-hidden text-left text-white">
                <div class="h-10 leading-10 w-full bg-light-lighter">
                  <img
                    :src="guild.icon ? 'https://cdn.discordapp.com/icons/' + guild.id + '/' + guild.icon + '?size=128' : 'https://cdn.discordapp.com/embed/avatars/0.png'"
